...
train = pd.read_csv("examples/stsbenchmark/data/stsbenchmark/sts-train-dev.csv", usecols=[4, 5, 6],
                    names=['labels', 'text_a', 'text_b'], sep='\t', engine="python", quotechar='"',
                    error_bad_lines=False)
eval_df = pd.read_csv("examples/stsbenchmark/data/stsbenchmark/sts-test.csv", usecols=[4, 5, 6],
                      names=['labels', 'text_a', 'text_b'], sep='\t', engine="python", quotechar='"',
                      error_bad_lines=False)
